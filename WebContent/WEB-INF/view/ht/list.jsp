		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="HtList"
								method="post">
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th scope="col">签订汽车</th>
										<th scope="col">签订时间</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="data">
										<tr>
											...
											<td>${data.car.name }</td>
											<td>${data.qysj }</td>
											<td> <a  href='downLoad?resPath=${data.htwj}' style="color:blue">点击下载</a>
				                	</td>
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="HtList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="HtList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>

						        <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                                        <li class="page-item"><a class="page-link" href="HtList?currentPage=${i }">${i }</a></li>
                                </c:forEach>
								...
								<li class="page-item"><a class="page-link"
									href="HtList?currentPage=${pageInfo.pages}">尾页</a></li>
