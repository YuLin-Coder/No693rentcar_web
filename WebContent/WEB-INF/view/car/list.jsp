		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="CarList"
								method="post">
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th scope="col">工作人员</th>
										<th scope="col">颜色</th>
										<th scope="col">车辆价格</th>
										<th scope="col">租车价格</th>
										<th scope="col">上牌时间</th>
										<th scope="col">行驶里程</th>
										<th scope="col">排放标准</th>
										<th scope="col">排量</th>
										<th scope="col">使用年限</th>
										<th scope="col">年检日期</th>
										<th scope="col">保险日期</th>
										...
										<tr>
											...
											<td>
                                             ...
                                             <td><img src="/images/${data.photo}" id="preview_img" style="width:50px; height:50px; "></td>											<td><input id="${data.id}" value="${data.id}"
												...
												href="toUpdateCar?id=${data.id }">修改</a> <a  class="btn btn-danger btn-sm del" 
 ...
 -->
							<ul class="pagination">
								<li class="page-item"><a class="page-link"
									href="CarList?currentPage=1">首页</a></li>
								<c:if test="${pageInfo.hasPreviousPage }">
									<li class="page-item"><a class="page-link"
										href="CarList?currentPage=${pageInfo.pageNum-1}">&lt;&lt;</a></li>
								</c:if>

						        <c:forEach begin="${pageInfo.pageNum  }"  end="${pageInfo.pages }" var="i">
                                        <li class="page-item"><a class="page-link" href="CarList?currentPage=${i }">${i }</a></li>
                                </c:forEach>
								...
								<li class="page-item"><a class="page-link"
									href="CarList?currentPage=${pageInfo.pages}">尾页</a></li>
