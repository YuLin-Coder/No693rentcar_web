...
<meta charset="UTF-8">
<meta name="viewport"
	content="width=device-width, CategoryDate-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
					...
					<div class="main">
						...
						<div class="form-box">
							<div class="row">
								<div class="col-5">
									<form id="saveForm">
									<input type="hidden" name="id" value="${CategoryDate.id }"> 

										
										<div class="form-group">
											<label>类型名称</label> <input type="text" name="name" value="${CategoryDate.name }"
										...
										<div class="form-group">
											<label>描述</label> <textarea   name="note"
												class="form-control">${CategoryDate.note }</textarea> <small
												class="form-text text-muted"></small>
										</div>
										
										

 										 <input type="hidden" name="photo" class="photo" value="${CategoryDate.photo }">
										   <div class="form-group">
